...
export default {
	...
	// cacheDirectory: "/private/var/folders/qf/8v4bbtyd29v9x4y1dnxr9g080000gp/T/jest_dy",
	...
	// The maximum amount of workers used to run your tests. Can be specified as % or a
	// number. E.g. maxWorkers: 10% will use 10% of your CPU amount + 1 as the maximum
